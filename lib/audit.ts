...
const actionLabels: Record<string, string> = {
  ...
  "user.two_factor_enabled": "Two-factor authentication turned on",
  "user.two_factor_disabled": "Two-factor authentication turned off",
  "user.backup_codes_regenerated": "Backup codes regenerated",
  "admin.two_factor_reset": "Two-factor reset by an admin",
  ...
  "support.customer_replied": "Support message sent",
  "admin.ticket_replied": "Support ticket answered",
  "admin.ticket_status_changed": "Support ticket status changed",
  "admin.plan_created": "Plan created",
  "admin.plan_updated": "Plan updated",
  "admin.plan_default_set": "Default plan changed",
  "admin.plan_activated": "Plan activated",
  "admin.plan_deactivated": "Plan deactivated",
  "admin.plan_assigned": "Organization plan changed",
